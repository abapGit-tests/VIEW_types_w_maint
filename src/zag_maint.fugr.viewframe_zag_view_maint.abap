*---------------------------------------------------------------------*
*    program for:   VIEWFRAME_ZAG_VIEW_MAINT
*---------------------------------------------------------------------*
FUNCTION VIEWFRAME_ZAG_VIEW_MAINT      .
...
*----------------------------------------------------------------------*
CALL FUNCTION 'VIEWPROC_ZAG_VIEW_MAINT'
         EXPORTING
              FCODE          = READ
...
EXTRACT = ZAG_VIEW_MAINT_EXTRACT
TOTAL = ZAG_VIEW_MAINT_TOTAL
              X_HEADER       = X_HEADER
              X_NAMTAB       = X_NAMTAB
...
CALL FUNCTION 'VIEWPROC_ZAG_VIEW_MAINT'
             ...
             IMPORTING
                  UCOMM           = FUNCTION
UPDATE_REQUIRED = STATUS_ZAG_VIEW_MAINT-UPD_FLAG
             TABLES
                  EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZAG_VIEW_MAINT_EXTRACT
TOTAL = ZAG_VIEW_MAINT_TOTAL
...
*----------------------------------------------------------------------*
      ...
      IF ( FUNCTION EQ SWITCH_TO_SHOW_MODE OR
           ...
           FUNCTION EQ END ) AND
STATUS_ZAG_VIEW_MAINT-UPD_FLAG NE SPACE.
        PERFORM BEENDEN.
        CASE SY-SUBRC.
          WHEN 0.
CALL FUNCTION 'VIEWPROC_ZAG_VIEW_MAINT'
...
TOTAL = ZAG_VIEW_MAINT_TOTAL
            ...
            CASE SY-SUBRC.
              WHEN 0.
IF STATUS_ZAG_VIEW_MAINT-UPD_FLAG EQ SPACE. EXIT. ENDIF.
...
IF STATUS_ZAG_VIEW_MAINT-UPD_FLAG NE SPACE.
...
CALL FUNCTION 'VIEWPROC_ZAG_VIEW_MAINT'
                    ...
                    IMPORTING
                              UPDATE_REQUIRED =
STATUS_ZAG_VIEW_MAINT-UPD_FLAG
                    TABLES
                        EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZAG_VIEW_MAINT_EXTRACT
TOTAL = ZAG_VIEW_MAINT_TOTAL
