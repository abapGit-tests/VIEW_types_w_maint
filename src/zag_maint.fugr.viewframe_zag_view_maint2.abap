*---------------------------------------------------------------------*
*    program for:   VIEWFRAME_ZAG_VIEW_MAINT2
*---------------------------------------------------------------------*
FUNCTION VIEWFRAME_ZAG_VIEW_MAINT2     .
...
*----------------------------------------------------------------------*
CALL FUNCTION 'VIEWPROC_ZAG_VIEW_MAINT2'
         EXPORTING
              FCODE          = READ
...
EXTRACT = ZAG_VIEW_MAINT2_EXTRACT
TOTAL = ZAG_VIEW_MAINT2_TOTAL
              X_HEADER       = X_HEADER
              X_NAMTAB       = X_NAMTAB
...
CALL FUNCTION 'VIEWPROC_ZAG_VIEW_MAINT2'
             ...
             IMPORTING
                  UCOMM           = FUNCTION
UPDATE_REQUIRED = STATUS_ZAG_VIEW_MAINT2-UPD_FLAG
             TABLES
                  EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZAG_VIEW_MAINT2_EXTRACT
TOTAL = ZAG_VIEW_MAINT2_TOTAL
...
*----------------------------------------------------------------------*
      ...
      IF ( FUNCTION EQ SWITCH_TO_SHOW_MODE OR
           ...
           FUNCTION EQ END ) AND
STATUS_ZAG_VIEW_MAINT2-UPD_FLAG NE SPACE.
        PERFORM BEENDEN.
        CASE SY-SUBRC.
          WHEN 0.
CALL FUNCTION 'VIEWPROC_ZAG_VIEW_MAINT2'
...
TOTAL = ZAG_VIEW_MAINT2_TOTAL
            ...
            CASE SY-SUBRC.
              WHEN 0.
IF STATUS_ZAG_VIEW_MAINT2-UPD_FLAG EQ SPACE. EXIT. ENDIF.
...
IF STATUS_ZAG_VIEW_MAINT2-UPD_FLAG NE SPACE.
...
CALL FUNCTION 'VIEWPROC_ZAG_VIEW_MAINT2'
                    ...
                    IMPORTING
                              UPDATE_REQUIRED =
STATUS_ZAG_VIEW_MAINT2-UPD_FLAG
                    TABLES
                        EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZAG_VIEW_MAINT2_EXTRACT
TOTAL = ZAG_VIEW_MAINT2_TOTAL
