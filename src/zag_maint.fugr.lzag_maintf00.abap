...
ENDFORM.
*---------------------------------------------------------------------*
FORM DB_UPD_ZAG_VIEW_MAINT .
*.process data base updates/inserts/deletes.........................*
LOOP AT TOTAL.
  CHECK <ACTION> NE ORIGINAL.
MOVE <VIM_TOTAL_STRUC> TO ZAG_VIEW_MAINT.
  IF <ACTION> = UPDATE_GELOESCHT.
    <ACTION> = GELOESCHT.
  ENDIF.
  CASE <ACTION>.
   WHEN NEUER_GELOESCHT.
IF STATUS_ZAG_VIEW_MAINT-ST_DELETE EQ GELOESCHT.
  ...
  PARAM_KEY = ZAG_VIEW_MAINT-PARAM_KEY .
    IF SY-SUBRC = 0.
...
ZAG_VIEW_MAINT-DATA_VALUE .
  ...
  ENDCASE.
ENDLOOP.
CLEAR: STATUS_ZAG_VIEW_MAINT-UPD_FLAG,
STATUS_ZAG_VIEW_MAINT-UPD_CHECKD.
MESSAGE S018(SV).
ENDFORM.
*---------------------------------------------------------------------*
FORM READ_SINGLE_ZAG_VIEW_MAINT.
...
ZAGTEST_TABLE_2-DATA_VALUE .
    ELSE.
      CLEAR SY-SUBRC.
      CLEAR ZAG_VIEW_MAINT-DATA_VALUE .
    ENDIF.
ENDFORM.
*---------------------------------------------------------------------*
FORM CORR_MAINT_ZAG_VIEW_MAINT USING VALUE(CM_ACTION) RC.
  DATA: RETCODE LIKE SY-SUBRC, COUNT TYPE I, TRSP_KEYLEN TYPE SYFLENG.
  FIELD-SYMBOLS: <TAB_KEY_X> TYPE X.
  CLEAR RC.
MOVE ZAG_VIEW_MAINT-PARAM_KEY TO
ZAGTEST_TABLE_1-PARAM_KEY .
MOVE ZAG_VIEW_MAINT-MANDT TO
ZAGTEST_TABLE_1-MANDT .
  CORR_KEYTAB             =  E071K.
